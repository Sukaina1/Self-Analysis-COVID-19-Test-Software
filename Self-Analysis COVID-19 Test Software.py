...
def typewriterstyle(string):  # function for adding type writer printing style with
    0.1
    s
    delay
...
def typewriterstyle1(string):  # function for adding type writer printing style with
    0.05
    s
    delay
...
if __name__ == '__main__':  # Main body
    ...
    Node5 = BinaryTreeNode("Have you had close contact with someone who's tested
    positive?")
    ...
    typewriterstyle('\n')
    Node1.Print()
    time_complexity1_start = time.time()  # starting timer time to calculate one node
    traversing
    of
    the
    tree
    ...
    Node2.Print()
    time_complexity1_end = time.time()  # ending timer of node traversal time
    checking
    timer
    ...
    opt = input()
    # Tertiary branching
    if 'Yes' == opt or opt == 'YES' or opt == 'yes' or opt == 'y' or opt ==
            'Y':
        typewriterstyle('>>> Isolate yourself from others and consider the
    best
    treatment.\n
    ')
    ...
    RN1.Print()
    elif opt == 'No' or opt == 'NO' or opt == 'no' or opt == 'n' or opt ==
         'N':
    Node5.Print()
    typewriterstyle1('\nType "Yes" for Yes.\nType "No" for No.\nEnter:
                     ')
    ...
    if 'Yes' == opt or opt == 'YES' or opt == 'yes' or opt == 'y' or opt
            == 'Y':
        typewriterstyle('>>> Still be safe and ensure social
    distancing.\n
    ')
    print('\n\n')
    print(Opening.center(100, "*"))
    ...
    typewriterstyle(">>> Visit the nearest health center or hospital as soon
    as possible.\n
    ")
    Node4.Print()
    typewriterstyle1('\nType "Yes" for Yes.\nType "No" for No.\nEnter: ')
    opt = input()
    # Secondary branching
    if opt == 'Yes' or opt == 'YES' or opt == 'yes' or opt == 'y' or opt ==
            'Y':
    ...
    if 'Yes' == opt or opt == 'YES' or opt == 'yes' or opt == 'y' or opt
            == 'Y':
        typewriterstyle1('>>> Still be safe and ensure social
    distancing.\n
    ')
    print('\n\n')
    print(Opening.center(100, "*"))
    ...
    if opt == 'Yes' or opt == 'YES' or opt == 'yes' or opt == 'y' or opt
            == 'Y':
        typewriterstyle('>>> Isolate yourself from others and consider
    the
    best
    treatment.\n
    ')
    ...
    print('Vaccination: ', Vaccination)
    RN1.Print()
    elif opt == opt == 'No' or opt == 'NO' or opt == 'no' or opt == 'n'
         or opt == 'N':
    Node5.Print()
    typewriterstyle1('\nType "Yes" for Yes.\nType "No" for
    No.\nEnter: ')
    opt = input()
    # Quaternary branching
    if 'Yes' == opt or opt == 'YES' or opt == 'yes' or opt == 'y' or
            opt == 'Y':
        typewriterstyle('>>> Still be safe and ensure social
    distancing.\n
    ')
    ...
    elif opt == 'No' or opt == 'NO' or opt == 'no' or opt == 'n' or
         opt == 'N':
    typewriterstyle('>>> Still be safe.\n')
    ...
    opt = input()
    # Tertiary branching
    if opt == opt == 'Yes' or opt == 'YES' or opt == 'yes' or opt == 'y'
            or opt == 'Y':
        typewriterstyle('>>> Take a leave and follow medication.\n')
    print('\n\n')
    print(Opening.center(100, "*"))
